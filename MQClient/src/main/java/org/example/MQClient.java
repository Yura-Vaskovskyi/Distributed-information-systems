...
public class MQClient {
    ...
    private Message requestResponse(String queueName, Message req) {
        ...
        try {
            ...
            if (response == null) {
                System.out.println("⚠️ WARNING: Server did not reply to " + queueName);
                return null;
            }
            ...
            System.out.println("⚠️ ERROR in requestResponse: " + e.getMessage());
            return null;
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        client.connect("tcp://100.64.161.89:61616"); // <--- YOUR IP HERE
        client.runCLI();
    }
}
